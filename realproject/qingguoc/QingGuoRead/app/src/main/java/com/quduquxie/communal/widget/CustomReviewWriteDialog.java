...
public class CustomReviewWriteDialog extends DialogFragment implements ExpressionListener {
    ...
    private OnReviewWriteSentClickListener onReviewWriteSentClickListener;
    ...
    public void onClickListener(View view) {
        switch (view.getId()) {
            ...
            case R.id.comment_post_sent:
                if (onReviewWriteSentClickListener != null) {
                    onReviewWriteSentClickListener.onReviewWriteSentClick(comment_post_input.getText().toString());
                }
                break;
    ...
    public void setOnReviewWriteSentClickListener(OnReviewWriteSentClickListener onReviewWriteSentClickListener) {
        this.onReviewWriteSentClickListener = onReviewWriteSentClickListener;
    }

    public interface OnReviewWriteSentClickListener {
        void onReviewWriteSentClick(String content);
    }
}
