...
package com.shortmeet.www.zTakePai.editt.effectmanager;
...
import com.shortmeet.www.zTakePai.editt.actionbar.ActionBarActivity;
import com.shortmeet.www.zTakePai.editt.http.EffectService;
...
public class MoreCaptionActivity extends ActionBarActivity implements
    ...
    public void onRemoteItemClick(final int position, final EffectBody<ResourceForm> data) {
        ...
        for (PasterForm pasterForm : materials) {
           ...
           //官方demo
        String guanfangurl="https://m-api.qupaicloud.com/api/res/get/1/91?packageName=com.aliyun.aliyunvideosdkpro&signature=7195598ccf30fe51d5dc6f1e94f855e4";
////         HttpRequest.get(requestUrl.toString(),
//            new StringHttpRequestCallback() {
            HttpRequest.get(guanfangurl,
                    new StringHttpRequestCallback() {
                        @Override
