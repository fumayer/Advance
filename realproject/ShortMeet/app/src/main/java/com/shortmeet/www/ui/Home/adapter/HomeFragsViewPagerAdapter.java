...
public class HomeFragsViewPagerAdapter extends IndicatorViewPager.IndicatorFragmentPagerAdapter{
    private Context mContext;
    private LayoutInflater mLayoutInflater;
    private List<String> sts;
    private List<Fragment> frags;

    public HomeFragsViewPagerAdapter(FragmentManager fragmentManager, Context context, List<String> stss,List<Fragment> frags) {
