...
package com.shortmeet.www.zTakePai.editt.effects.audiomix;
...
public class AudioMixChooserMediator extends BaseChooser implements OnItemClickListener, OnClickListener {
 ...
 //官方demo https://m-api.qupaicloud.com/api/res/type/5?packageName=com.aliyun.aliyunvideosdkpro&signature=7195598ccf30fe51d5dc6f1e94f855e4
        String guanurl="https://m-api.qupaicloud.com/api/res/type/5?packageName=com.aliyun.aliyunvideosdkpro&signature=7195598ccf30fe51d5dc6f1e94f855e4";
        Logger.getDefaultLogger().d("pasterUrl url = " +requestUrl.toString());
        HttpRequest.get(guanurl,
