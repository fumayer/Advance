...
import com.shortmeet.www.zTakePai.crop.media.GalleryDirChooser;
import com.shortmeet.www.zTakePai.crop.media.GalleryMediaChooser;
import com.shortmeet.www.zTakePai.crop.media.MediaDir;
import com.shortmeet.www.zTakePai.crop.media.MediaInfo;
import com.shortmeet.www.zTakePai.crop.media.MediaStorage;
import com.shortmeet.www.zTakePai.crop.media.ThumbnailGenerator;
    ...
    private void init(){
        ...
        storage.setOnCurrentMediaInfoChangeListener(new MediaStorage.OnCurrentMediaInfoChange() {
            ...
            public void onCurrentMediaInfoChanged(MediaInfo info) {
                ...
                String a=     info.filePath;
                // ///storage/emulated/0/Tencent/QQ_Images/-118ea22683cbf1f6.jpg
                ///storage/emulated/0/outputVideo1505635001154.mp4
                String b=a+"------>bb";
                if(info == null){

                    Class recorder = null;
                    try {
                        recorder = Class.forName("com.shortmeet.www.zTakePai.record.AliyunVideoRecorder");
                    ...
                    if(info.mimeType.startsWith("image")) {
                        ...
                        intent.putExtra(AliyunVideoCrop.VIDEO_PATH, info.filePath);
                        intent.putExtra(AliyunSnapVideoParam.VIDEO_RESOLUTION, resolutionMode);
