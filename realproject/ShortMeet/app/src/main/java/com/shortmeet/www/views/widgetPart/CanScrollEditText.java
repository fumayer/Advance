...
/**
 * Created by SHM on 2017/05/05.
 * 用于处理ScrollView嵌套的时候滑动事件的冲突
 */
public class CanScrollEditText extends EditText {
    ...
    public CanScrollEditText(Context context, AttributeSet attrs, int defStyleAttr) {
