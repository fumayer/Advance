...
//            protected void onSuccess(String s) {
        ...
        //官方 ：
//https://m-api.qupaicloud.com/api/res/type/2----------parapackageName=com.aliyun.aliyunvideosdkpro&signature=7195598ccf30fe51d5dc6f1e94f855e4
        String guanfangurl="https://m-api.qupaicloud.com/api/res/type/2";
//        String guangfangparams="com.aliyun.aliyunvideosdkpro&signature=7195598ccf30fe51d5dc6f1e94f855e4";
        params.addFormDataPart("packageName", "com.aliyun.aliyunvideosdkpro");
        params.addFormDataPart("signature", "7195598ccf30fe51d5dc6f1e94f855e4");
        HttpRequest.get(guanfangurl, params, new StringHttpRequestCallback() {
            @Override
            protected void onSuccess(String s) {
                super.onSuccess(s);
                try {
...
//        params.addFormDataPart("signature", signature);
        //官方 ：
//https://m-api.qupaicloud.com/api/res/type/3----------parapackageName=com.aliyun.aliyunvideosdkpro&signature=7195598ccf30fe51d5dc6f1e94f855e4
        String guanfangurl="https://m-api.qupaicloud.com/api/res/type/3";
        params.addFormDataPart("packageName", "com.aliyun.aliyunvideosdkpro");
        params.addFormDataPart("signature", "7195598ccf30fe51d5dc6f1e94f855e4");
        HttpRequest.get(url, params, new StringHttpRequestCallback() {
            @Override
...
//        params.addFormDataPart("packageName", packageName);
//        params.addFormDataPart("signature", signature);
        String guanfangurl="https://m-api.qupaicloud.com/api/res/type/"+type;
        params.addFormDataPart("packageName", "com.aliyun.aliyunvideosdkpro");
        params.addFormDataPart("signature", "7195598ccf30fe51d5dc6f1e94f855e4");
        HttpRequest.get(guanfangurl, params, new StringHttpRequestCallback() {
            @Override
