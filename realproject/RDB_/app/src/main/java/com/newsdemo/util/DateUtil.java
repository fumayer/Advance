...
public class DateUtil {
    ...
    public static String formatTime2String(long showTime){
        return formateTime2String(showTime,false);
    }

    public static String formateTime2String(long showTime,boolean haveYear){
        String str="";
        long disance=System.currentTimeMillis()/1000-showTime;
        if (disance<300){
            str="刚刚";
        }else if (disance>=300 && disance<600){
            str="5分钟前";
        }else if (disance>=600 && disance<1200){
            str="10分钟前";
        }else if (disance>=1200 && disance<1800){
            str="20分钟前";
        }else if (disance>1800 && disance<=2700){
            str="半个小时前";
        }else if(disance>=2700){
