package com.aiwue.ui.view.colortrackview;
...
import com.aiwue.theme.colorUi.util.ViewAttributeUtil;
...
//                if (mIndicatorColor != -1)
    ...
    public void setTitles(CaptionTitle[] titles, CorlorTrackTabBack callBack) {
        this.mTitles = titles;
...
//        setWeightSum(mTitles.length);
        for (int i = 0; i < mTitles.length; i++) {
            ...
            colorTrackView.setText(this.mTitles[i].getName());
