...
public class AlbumListAdapter extends BaseQuickAdapter<Note,BaseViewHolder> {
    private ImageView album_img;
    public AlbumListAdapter(List<Note> data) {super(R.layout.item_album_riverlake, data);}
    @Override
