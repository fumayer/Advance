package com.aiwue.theme.colorUi.util;
...
import com.aiwue.theme.colorUi.ColorUiInterface;
...
//        }
//        ta.recycle();
//        Resources resources = AiwueApplication.getInstance().getResources();
...
//            int resId = resources.getIdentifier(drawableName + "_night", "drawable", AiwueApplication.getInstance().getPackageName());
//        }
//    }
    ...
    public static boolean isLightTheme() {
        return SharedPreferencesMgr.getInt(ConstantValue.SP_THEME, ConstantValue.THEME_LIGHT) == ConstantValue.THEME_LIGHT;
    }
...
//            Logger.i("drawableName:" + drawableName + ",newDrawableName:" + newDrawableName);
            int newResId = res.getIdentifier(newDrawableName, "drawable", AiwueApplication.getInstance().getPackageName());
