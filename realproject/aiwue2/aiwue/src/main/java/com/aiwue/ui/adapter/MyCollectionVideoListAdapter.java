...
/**
 * 主页中的图集列表页面的adapter
 * Created by Chenhui on 2017年4月19日12:53:31
 * Copyright (c) 2017 aiwue.com All rights reserved
 */
public class MyCollectionVideoListAdapter extends BaseQuickAdapter<Note, BaseViewHolder> {
    public MyCollectionVideoListAdapter(List<Note> data) {
