...
public class PagerSlidingTabStrip extends HorizontalScrollView implements View.OnClickListener {
    ...
    public PagerSlidingTabStrip(Context context) {
        this(context, null);
        tab_line_height = DeviceUtil.dip2px(context, 2);
        dividerPadding = DeviceUtil.dip2px(context, dividerPadding);
    }

    public PagerSlidingTabStrip(Context context, AttributeSet attrs) {
        super(context, attrs);
        setHorizontalScrollBarEnabled(false); // 隐藏横向滑动提示条
        tab_line_height = DeviceUtil.dip2px(context, 3);
        dividerPadding = DeviceUtil.dip2px(context, dividerPadding);
        if (attrs != null) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (tabsLayout != null && tabsLayout.getChildCount() > 0
            ...
            if (currentTab != null) {
                ...
                slidingBlockDrawable.setBounds((int) slidingBlockLeft + dividerPadding, getHeight() - tab_line_height, (int) slidingBlockRight - dividerPadding, getHeight());
    ...
    public void setDividerPadding(int dividerPaddingPx) {
        this.dividerPadding = DeviceUtil.dip2px(getContext(), dividerPaddingPx);
        invalidate();
    }
