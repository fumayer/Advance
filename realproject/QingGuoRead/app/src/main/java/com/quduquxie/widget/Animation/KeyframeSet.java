...
package com.quduquxie.widget.Animation;

import android.view.animation.Interpolator;

import com.quduquxie.util.QGLog;
import com.quduquxie.widget.Animation.Keyframe.FloatKeyframe;
import com.quduquxie.widget.Animation.Keyframe.IntKeyframe;
import com.quduquxie.widget.Animation.Keyframe.ObjectKeyframe;
...
class KeyframeSet {
    ...
    public static KeyframeSet ofFloat(float... values) {
        ...
        if (badValue) {
            QGLog.w("Animator", "Bad value (NaN) in float animator");
        }
