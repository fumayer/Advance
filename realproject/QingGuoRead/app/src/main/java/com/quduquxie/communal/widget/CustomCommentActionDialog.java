...
public class CustomCommentActionDialog extends DialogFragment implements ExpressionListener {
    ...
    private OnCommentActionReplySentClickListener onCommentActionReplySentClickListener;
    ...
    public void onClickListener(View view) {
        switch (view.getId()) {
            ...
            case R.id.comment_post_sent:
                if (review != null && onCommentActionReplySentClickListener != null) {
                    onCommentActionReplySentClickListener.onCommentActionReplySentClicked(review, comment_post_input.getText().toString());
                }
                break;
    ...
    public void setCommentActionData(Review review) {
        this.review = review;
    }

    public void setOnCommentActionSentClickListener(OnCommentActionReplySentClickListener onCommentActionReplySentClickListener) {
        this.onCommentActionReplySentClickListener = onCommentActionReplySentClickListener;
    }

    public interface OnCommentActionReplySentClickListener {
        void onCommentActionReplySentClicked(Review review, String content);
    }
}
