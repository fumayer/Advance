...
public class LocalViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public LocalViewPagerAdapter(FragmentManager fragmentManager, PagerSlidingTabStrip pageStrip, ViewPager viewPager) {
    ...
    /**
     * 移除一个tab 备注：如果index小于0，则从第一个开始删 如果大于tab的数量值则从最后一个开始删除
     */
