...
import com.quduquxie.creation.write.widget.utils.ContentTextWatcher;
import com.quduquxie.creation.write.widget.utils.CustomInputFilter;
import com.quduquxie.creation.write.widget.utils.TitleTextWatcher;
import com.quduquxie.creation.write.widget.utils.LiteratureWriteListener;
...
public class LiteratureWriteContentView extends RelativeLayout implements LiteratureWriteListener, TitleTextWatcher.TitleCountChangeListener, ContentTextWatcher.ContentCountChangeListener, View.OnClickListener {

    private static final String TAG = LiteratureWriteContentView.class.getSimpleName();
    ...
    private LiteratureWriteContentListener literatureWriteContentListener;
    ...
    public LiteratureWriteContentView(Context context) {
        super(context);
        initView(context);
        this.contextReference = new WeakReference<>(context);
    }

    public LiteratureWriteContentView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
        this.contextReference = new WeakReference<>(context);
    }

    public LiteratureWriteContentView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public LiteratureWriteContentView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.literature_write_util_keyboard:
                if (keyword_closed) {
                    if (literatureWriteContentListener != null) {
                        if (literature_write_title_input.hasFocus()) {
                            if (literature_write_title_input != null) {
                                literatureWriteContentListener.showKeyboard(literature_write_title_input);
                            }
                        } else if (literature_write_content.hasFocus()) {
                            if (literature_write_content != null) {
                                literatureWriteContentListener.showKeyboard(literature_write_content);
                            }
                        }
                    }
                } else {
                    if (literatureWriteContentListener != null) {
                        if (literature_write_title_input.hasFocus()) {
                            if (literature_write_title_input != null) {
                                literatureWriteContentListener.hideKeyboard(literature_write_title_input);
                            }
                        } else if (literature_write_content.hasFocus()) {
                            if (literature_write_content != null) {
                                literatureWriteContentListener.hideKeyboard(literature_write_content);
                            }
                        }
                    }
                }
    ...
    public void setLiteratureWriteContentListener(LiteratureWriteContentListener literatureWriteContentListener) {
        this.literatureWriteContentListener = literatureWriteContentListener;
        if (literature_write_content != null) {
    ...
    public void checkTitleInput() {
        if (toast == null) {
            if (contextReference.get() != null) {
                toast = Toast.makeText(contextReference.get(), "检测到章节标题含有非法字符！", Toast.LENGTH_SHORT);
            }
        } else {
            toast.setText("检测到章节标题含有非法字符！");
        }
        if (toast != null)
            toast.show();
    }
    ...
    public void setContentCountChanged(int length) {
        if (literatureWriteContentListener != null) {
            literatureWriteContentListener.setContentLength(length);
        }
    }
