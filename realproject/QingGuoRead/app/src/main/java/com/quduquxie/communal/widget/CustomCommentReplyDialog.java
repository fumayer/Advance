...
public class CustomCommentReplyDialog extends DialogFragment implements ExpressionListener {
    ...
    private OnCommentReplySentClickListener onCommentReplySentClickListener;
    ...
    public void onClickListener(View view) {
        switch (view.getId()) {
            ...
            case R.id.comment_post_sent:
                if (comment != null && onCommentReplySentClickListener != null) {
                    onCommentReplySentClickListener.onCommentReplySentClicked(comment, commentUser, comment_post_input.getText().toString());
                }
                break;
    ...
    public void setReplyUser(CommentUser commentUser) {
        ...
        if (comment_post_input != null) {
            comment_post_input.setText("@" + commentUser.name + " ");
        }
    }
    ...
    public void setOnCommentReplySentClickListener(OnCommentReplySentClickListener onCommentReplySentClickListener) {
        this.onCommentReplySentClickListener = onCommentReplySentClickListener;
    }

    public interface OnCommentReplySentClickListener {
        void onCommentReplySentClicked(Comment comment, CommentUser commentUser, String content);
    }
}
