...
public class SBottomNavigationView extends BottomNavigationView {
    ...
    public SBottomNavigationView(Context context) {
        super(context);
    }
    ...
    public SBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        System.out.println("mMenuView:" + mMenuView + " mButtons:" + mButtons + " mOnClickListener" + mOnClickListener);
    ...
    public void setSmallTextSize(float px) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
            getSmallLabelAt(i).setTextSize(TypedValue.COMPLEX_UNIT_PX,px);
        }
        mMenuView.updateMenuView();
    }


    public void setLargeTextSize(float px) {
        int count = getItemCount();
        for (int i = 0; i < count; i++) {
            getLargeLabelAt(i).setTextSize(TypedValue.COMPLEX_UNIT_PX,px);
        }
        mMenuView.updateMenuView();
    }
    ...
    public void setIconSizeAt(int position, int width, int height) {
